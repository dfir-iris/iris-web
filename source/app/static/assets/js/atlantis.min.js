...
$('.nav-search .input-group > input').focus(function (a) {
	...
	$('[data-toggle="tooltip"]').tooltip(), layoutsColors();
	...
	var c = !1, d = !1, g = !1, p = !1, h = 0, m = 0, n = 0, u = 0, v = 0, f = 0, b = 0;
	if (!c) {
    ...
    if (!n) {
		var C = $('.ds-sidebar-toggler');
		C.on('click', function () {
		    console.log('hey');
			1 == h ? ($('html').removeClass('ds_sidebar_open'), $('.ds-sidebar-overlay').remove(), C.removeClass('toggled'), n = 0) : ($('html').addClass('ds_sidebar_open'), C.addClass('toggled'), n = 1);
		}), $('.wrapper').mouseup(function (a) {
			var e = $('.ds-sidebar');
			a.target.className == e.attr('class') || e.has(a.target).length || ($('html').removeClass('ds_sidebar_open'), $('.ds-sidebar-toggler').removeClass('toggled'), $('.ds-sidebar-overlay').remove(), n = 0);
		}), $('.close-ds-sidebar').on('click', function () {
			$('html').removeClass('ds_sidebar_open'), $('.ds-sidebar-toggler').removeClass('toggled'), $('.ds-sidebar-overlay').remove(), n = 0;
		}), n = !0;
	}
	if (!d) {
