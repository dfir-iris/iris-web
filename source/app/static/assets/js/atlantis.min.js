...
$(document).ready(function(){
    $('.nav-search .input-group > input').focus(function (a) {
        ...
        if (!g) {
            ...
            var v = localStorage.getItem('iris-sidebar-mini');
            if (v == "false") {$('.wrapper').addClass('sidebar_minimize'), k.addClass('toggled'), k.html('<i class="icon-options-vertical"></i>');$(window).resize();}
            $('.wrapper').hasClass('sidebar_minimize') && (v = "false", k.addClass('toggled'), k.html('<i class="icon-options-vertical"></i>')), k.on('click', function () {
                v = localStorage.getItem('iris-sidebar-mini');
                "false" == v ? ($('.wrapper').removeClass('sidebar_minimize'), k.removeClass('toggled'), k.html('<i class="icon-menu"></i>'), localStorage.setItem('iris-sidebar-mini', true)) : ($('.wrapper').addClass('sidebar_minimize'), k.addClass('toggled'), k.html('<i class="icon-options-vertical"></i>'), localStorage.setItem('iris-sidebar-mini', false)), $(window).resize();
            }), g = !0;
        }
        if (!p) {
