                        ...
                        <div class="collapse mt-3" id="relationsAlert-${alert.alert_id}">
                            ...
                            <div class="selectgroup selectgroup-pills mt-4">
                                <label class="selectgroup-item">
                                    <input type="checkbox" name="value" value="open_alerts" class="selectgroup-input filter-graph-alert-checkbox" checked="">
                                    <span class="selectgroup-button">Show open alerts</span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="checkbox" name="value" value="closed_alerts" class="selectgroup-input filter-graph-alert-checkbox" checked="">
                                    <span class="selectgroup-button">Show closed alerts</span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="checkbox" name="value" value="open_cases" class="selectgroup-input filter-graph-alert-checkbox">
                                    <span class="selectgroup-button">Show open cases</span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="checkbox" name="value" value="closed_cases" class="selectgroup-input filter-graph-alert-checkbox">
...
$(document).ready(function () {
  ...
  $('#select-deselect-all').on('click', function() {
    ...
    $('.filter-graph-alert-checkbox').on('change', function() {
        ...
        fetchSimilarAlerts(fetch_open_alerts, fetch_closed_alerts, fetch_open_cases, fetch_closed_cases);
    });
