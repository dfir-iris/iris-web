...
def add_asset(caseid):
    ...
    try:
        ...
        if request_data.get('ioc_links'):
            ...
            if errors:
                return response_error(f'Encountered errors while linking IOC. Asset yet created. {logs}')
...
def asset_update(cur_id, caseid):
    ...
    try:
        ...
        if hasattr(asset_schema, 'ioc_links'):
            ...
            if errors:
                return response_error(f'Encountered errors while linking IOC. Asset yet updated. {logs}')
